...
public class AndroidUtils {
    ...
    public static Uri getOutputMediaFileUri(Context context, String name, int type) throws FileNotFoundException {
        return Uri.fromFile(getOutputMediaFile(context,name, type));
    }

    /** Create a File for saving an image or video */
    public static File getOutputMediaFile(Context context, String name, int type) throws FileNotFoundException {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.FROYO) {
                ...
                if (type == MEDIA_TYPE_IMAGE)
                    mediaStorageDir = context.getExternalFilesDir(
    ...
    public static boolean isLowBandwithNetwork(Context applicationContext){
        ...
        if (!wifi.isConnectedOrConnecting()){
            ...
            if (tm != null && (tm.getNetworkType() == TelephonyManager.NETWORK_TYPE_EDGE || tm.getNetworkType() == TelephonyManager.NETWORK_TYPE_GPRS)){
                    return true;
            }
        }
        return false;
