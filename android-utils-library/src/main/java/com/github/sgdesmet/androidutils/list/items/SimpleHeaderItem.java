package com.github.sgdesmet.androidutils.list.items;
...
import com.github.sgdesmet.androidutils.list.ListItem;
...
public class SimpleHeaderItem implements ListItem {
    ...
    public View inflate(final View convertView, final ViewGroup parent) {
        ...
        if (convertView == null ) {
            ...
            rowView = inflater.inflate( R.layout.row_header, null );
