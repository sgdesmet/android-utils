...
/**
 * See http://stackoverflow.com/questions/785973/what-is-the-most-appropriate-way-to-store-user-settings-in-android-application
 * Just obfuscating the password actually here, this is almost useless.
 *
 * <p/>
 * Date: 03/09/12
 * Time: 12:09
...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    private static final String DEFAULT_SECRET = "ztD/ZHadJheUpV/g";
    ...
    /**
     * Uses a default secret. Even less secure.
     * @param context
     * @param delegate
     */
    @Deprecated
    public ObscuredSharedPreferences(Context context, SharedPreferences delegate) {
        this(context, delegate, DEFAULT_SECRET);
    }
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putStringSet(String key, Set<String> values) {
            throw new UnsupportedOperationException(); // TODO: should implement this
        }
    }
