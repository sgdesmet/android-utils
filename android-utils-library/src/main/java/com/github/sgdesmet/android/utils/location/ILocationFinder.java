...
package com.github.sgdesmet.android.utils.location;
...
public interface ILocationFinder {
     ...
     * @param minDistance
     * @param minTime
     * @param maxFixTime maximum time to wait to get a location
     * @param maxRetries number of times to retry if we can't get a location
     * @param l
     * @throws NoProviderAvailableException
     */
    public void getLocation(int minDistance, long minTime, long maxFixTime, int maxRetries, LocationListener l) throws NoProviderAvailableException;
